...
- **Prerequisites**: We recommend you first complete the following courses: [Hello, GitHub Actions](https://github.com/Lepont-DataEng/02-hello-github-actions)
...
'https://github.com/new?' + new URLSearchParams({
  template_owner: 'Lepont-DataEng',
  template_name: 'publish-packages',
  owner: '@me',
  name: 'Lepont-DataEng-03-publish-packages',
  description: 'My clone repository',
  visibility: 'public',
}).toString()
-->

[![start-course](https://user-images.githubusercontent.com/1221423/235727646-4a590299-ffe5-480d-8cd5-8194ea184546.svg)](https://github.com/new?template_owner=Lepont-DataEng&template_name=03-publish-packages&owner=%40me&name=Lepont-DataEng-03-publish-packages&description=My+clone+repository&visibility=public)
